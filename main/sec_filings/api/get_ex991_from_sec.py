...
def get_ex991(start_date_string: str, end_date_string: str, unique_filings: List[PartialFiling], page: int = 1) -> List[PartialFiling]:
    ...
    query = {
        "query": '"entered into" merger "exhibit 99.1" -"credit agreement" -"license agreement" -"isda" -"pro forma" -"acquisition corp" -"acquisition corporation" -"acquisition corporation," -"previously announced acquisition" -"previously announced merger" -"previously announced transaction" -"acquisition company" -"acquisition company," -"special purpose acquisition company" -"acquisition holdings" -"loan agreement" -"completion of acquisition"',
        "formTypes": ['8-K'],
